...
public final class BackgroundInstallControlServiceTest {
    ...
    @Mock private PermissionManagerServiceInternal mPermissionManager;
    @Mock private BackgroundInstallControlCallbackHelper mCallbackHelper;

    @Captor
    private ArgumentCaptor<PackageManagerInternal.PackageListObserver> mPackageListObserverCaptor;

    @Captor private ArgumentCaptor<UsageEventListener> mUsageEventListenerCaptor;
    ...
    public void setUp() {
        ...
        when(mContext.checkCallingPermission(INTERACT_ACROSS_USERS_FULL))
    ...
    public void checkCallerPermissionsWithOnlyQueryAllPackagesPermissionThrowsSecurityException() {
        when(mContext.checkCallingPermission(QUERY_ALL_PACKAGES)).thenReturn(PERMISSION_GRANTED);
        when(mContext.checkCallingPermission(INTERACT_ACROSS_USERS_FULL))
    ...
    @Test(expected = SecurityException.class)
    public void checkCallerPermissionsWithOnlyQueryUsersPermissionThrowsSecurityException() {
