...
class AppOpsUidStateTrackerImpl2 implements AppOpsUidStateTracker {

    private static final String LOG_TAG = AppOpsUidStateTrackerImpl2.class.getSimpleName();
    ...
    AppOpsUidStateTrackerImpl2(ActivityManagerInternal activityManagerInternal,
        ...
        if ((pendingStateCommitTime == 0
            ...
            if (procState == PROCESS_STATE_NONEXISTENT) {
                ...
                mExecutor.executeDelayed(PooledLambda.obtainRunnable(
                                AppOpsUidStateTrackerImpl2::updateUidPendingStateIfNeeded, this,
                                uid), settleTime + 1);
            }
        }
    }
