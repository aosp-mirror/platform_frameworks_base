...
public:
    ...
    void setSurface(int deviceId, int streamId, const sp<Surface>& surface);
...
void JTvInputHal::setSurface(int deviceId, int streamId, const sp<Surface>& surface) {
...
static void nativeSetSurface(JNIEnv* env, jclass clazz,
    ...
    sp<Surface> surface(
            ...
            : NULL);
    tvInputHal->setSurface(deviceId, streamId, surface);
}
...
static JNINativeMethod gTvInputHalMethods[] = {
    ...
    { "nativeOpen", "()J",
            (void*) nativeOpen },
    { "nativeSetSurface", "(JIILandroid/view/Surface;)V",
...
int register_android_server_tv_TvInputHal(JNIEnv* env) {
    ...
    jclass clazz;
    FIND_CLASS(clazz, "android/tv/TvInputHal");
