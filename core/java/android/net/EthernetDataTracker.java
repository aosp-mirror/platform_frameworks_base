...
public class EthernetDataTracker implements NetworkStateTracker {
    ...
    public static EthernetDataTracker sInstance;
    ...
    private static class InterfaceObserver extends INetworkManagementEventObserver.Stub {
        ...
        InterfaceObserver(Handler handler, LinkProperties properties, NetworkInfo networkInfo) {
            super();
            mCsHandler = handler;
        ...
        public void interfaceRemoved(String iface) {
            ...
            android.util.Log.e(TAG, "Removing " + iface);
    ...
    public void startMonitoring(Context context, Handler target) {
        ...
        mInterfaceObserver = new InterfaceObserver(mCsHandler, mLinkProperties, mNetworkInfo);
        try {
