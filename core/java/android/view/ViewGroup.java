...
public abstract class ViewGroup extends View implements ViewParent, ViewManager {
    ...
    // When set, this ViewGroup caches its children in a Bitmap before starting a
    // layout animation
    // Set by default
    ...
    // When the previous drawChild() invocation used an alpha value that was lower
    // than
    ...
    /**
     * When set, and if FLAG_ALWAYS_DRAWN_WITH_CACHE is not set, this ViewGroup will
     * try to draw its children with their drawing cache.
     */
    ...
    /**
     * Perform dispatching of a {@link #saveHierarchyState freeze()} to only this
     * view, not to its children. For use when overriding
     * {@link #dispatchSaveInstanceState dispatchFreeze()} to allow subclasses to
     * freeze their own state but not the state of their children.
     *
    ...
    /**
     * Perform dispatching of a {@link #restoreHierarchyState thaw()} to only this
     * view, not to its children. For use when overriding
     * {@link #dispatchRestoreInstanceState dispatchThaw()} to allow subclasses to
     * thaw their own state but not the state of their children.
     *
     * @param container the container
     */
     ...
     *
     * @param clipToPadding true to clip children to the padding of the group, false
     *                      otherwise
     * @attr ref android.R.styleable#ViewGroup_clipToPadding
     */
     ...
     * children so it can be retrieved by calling {@link #getChildAt(int)}.
     *
     ...
     * account both the MeasureSpec requirements for this view and its padding. We
     * skip children that are in the GONE state The heavy lifting is done in
     * getChildMeasureSpec.
     *
    ...
    public static class LayoutParams {
         ...
         * FILL_PARENT (replaced by MATCH_PARENT , in API Level 8) or WRAP_CONTENT. or
         * an exact size.
         */
