...
public class DeviceAdminReceiver extends BroadcastReceiver {
    ...
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_CHOOSE_PRIVATE_KEY_ALIAS = "android.app.action.ACTION_CHOOSE_PRIVATE_KEY_ALIAS";
   ...
   /**
     ...
     * @param port The authentication post, may be null.
