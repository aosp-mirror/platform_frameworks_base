...
public class QSTileHostTest extends SysuiTestCase {
    ...
    public void setUp() {
        ...
        setUpTileFactory();
<<<<<<< TARGET BRANCH (8bb530 Merge "Correctly clip QS during heads-up pull down" into sc-)
=======
        ...
        when(mSecureSettings.getStringForUser(eq(QSTileHost.TILES_SETTING), anyInt()))
                .thenReturn("");
>>>>>>> SOURCE BRANCH (0e2e59 [DO NOT MERGE] Make sure WiFi and Cell tiles are not created)
    }
