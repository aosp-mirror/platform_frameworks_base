...
public class QsHeaderWeather extends TextView implements
    ...
    private int mWeatherTextFontStyle = FONT_NORMAL;
    ...
    private int mWeatherFontSize = 14;
    ...
    private void updateStyle() {
        mWeatherTextFontStyle = Settings.System.getInt(mContext.getContentResolver(),
                Settings.System.STATUS_BAR_WEATHER_FONT_STYLE, FONT_NORMAL);
        getFontStyle(mWeatherTextFontStyle);
    }

    private void updateSize() {
        mWeatherFontSize = Settings.System.getInt(mContext.getContentResolver(),
                Settings.System.STATUS_BAR_WEATHER_FONT_SIZE, 14);
        setTextSize(mWeatherFontSize);
    }
