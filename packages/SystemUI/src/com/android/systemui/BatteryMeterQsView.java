...
public class BatteryMeterQsView extends View implements DemoMode {
    public static final String TAG = BatteryMeterQsView.class.getSimpleName();
    ...
    public BatteryMeterQsView(Context context) {
        this(context, null, 0);
    }

    public BatteryMeterQsView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BatteryMeterQsView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        final Resources res = context.getResources();
        TypedArray levels = res.obtainTypedArray(R.array.batterymeterqs_color_levels);
        TypedArray colors = res.obtainTypedArray(R.array.batterymeterqs_color_values);
        ...
        mFramePaint.setColor(res.getColor(R.color.batterymeterqs_frame_color));
        ...
        mChargeColor = getResources().getColor(R.color.batterymeterqs_charge_color);

        mBoltPaint = new Paint();
        mBoltPaint.setAntiAlias(true);
        mBoltPaint.setColor(res.getColor(R.color.batterymeterqs_bolt_color));
