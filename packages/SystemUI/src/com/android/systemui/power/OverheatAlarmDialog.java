...
public class OverheatAlarmDialog extends AlertDialog {
    ...
    private static boolean mHasUserInteracted;
    ...
    private void setupDialog() {
        ...
        mPowerEventReceiver = new OverheatAlarmDialog.PowerEventReceiver(this);
    ...
    private final class PowerEventReceiver extends BroadcastReceiver {
        ...
        private PowerEventReceiver(Dialog dialog) {
            this.dialog = dialog;
        }
