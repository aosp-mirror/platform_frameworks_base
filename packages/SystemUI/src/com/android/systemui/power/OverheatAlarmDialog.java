...
public class OverheatAlarmDialog extends AlertDialog {
    ...
    private View mContentView, mTitleView;
    private OverheatAlarmDialog.PowerEventReceiver mPowerEventReceiver;
    private OverheatDialogDelegate mOverheatDialogDelegate;

    /**
     * OverheatAlarmDialog should appear over panels and keyguard
     */
    ...
    /**
     * The main purpose of building custom title and message views is to inject
     * AccessibilityDelegate handling beep sound and talkback mix up problem.
     */
    ...
    public void setTitle(CharSequence title) {
        ...
        TextView titleTextView = mTitleView.findViewById(R.id.alertTitle);
    ...
    public void setIconAttribute(int attrId) {
        ...
        ImageView iconView = mTitleView.findViewById(R.id.icon);
        if (iconView != null) {
    ...
    public void setMessage(CharSequence message) {
        ...
        TextView messageView = mContentView.findViewById(R.id.message);
        if (messageView != null) {
