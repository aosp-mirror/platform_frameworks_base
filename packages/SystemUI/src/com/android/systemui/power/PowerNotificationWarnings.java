...
public class PowerNotificationWarnings implements PowerUI.WarningsUI {
     ...
     *
     * Overheat |Undismissible |Dismissible   |   Next action
     *  status  |dialog showing|dialog showing|
     *    F     |      F       |       F      | PASS
     *    F     |      F       |       T      | PASS
     *    F     |      T       |       F      | Show DismissibleDialog, dismiss UndismissibleDialog
     *    F     |      T       |       T      | Reset, show DismissibleDialog
     *    T     |      F       |       F      | Show UndismissibleDialog
     *    T     |      F       |       T      | Show UndismissibleDialog, dismiss DismissibleDialog
     *    T     |      T       |       F      | PASS
     *    T     |      T       |       T      | Reset, dismiss UndismissibleDialog
     */
    @Override
     ...
     *
     * @param showing whether showing the un-dismissible alarm dialog or not
     */
     ...
     *
     * @param showing whether showing the dismissible alarm dialog or not
     */
    ...
    /**
     * Alarm beep sound when overheat dialog showing
     * @param shouldSound should alarm beep sound or not
     */
