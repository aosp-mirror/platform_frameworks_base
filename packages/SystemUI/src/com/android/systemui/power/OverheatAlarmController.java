...
/**
 * A Controller handle Beep sound, vibrate and TTS base on OverheatAlarmDialog showing state
 */
@VisibleForTesting
public class OverheatAlarmController implements TextToSpeech.OnInitListener,
    ...
    /**
     * OverheatAlarmController Singleton design pattern
     */
    ...
    /**
     * Stop alarming beep sound, vibrating, and TTS if exist
     */
    @VisibleForTesting
    ...
    protected void playSound() {
        Uri uri = Uri.parse(
                "android.resource://" + mContext.getBasePackageName() + "/" + R.raw.overheat_alarm);
        if (mPlayer == null) {
