 ...
 */
@SysUISingleton
public class CentralSurfacesImpl implements CoreStartable, PackageChangedListener, CentralSurfaces {
    ...
    private XtndSettingsObserver mXtndSettingsObserver = new XtndSettingsObserver(mMainHandler);
